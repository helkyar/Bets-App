...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="<%= path %>/css/mainpage.css" media="screen" />
        ...
        <div class="c-destacados-home c-2-destacados">
            ...
            <picture ><source  type="image/webp" sizes="(min-width: 260px) 260px, 100vw" srcset="../img/mobile-device.png 621w"><img data-gatsby-image-ssr="" data-main-image="" style="opacity: 1;" sizes="(min-width: 621px) 621px, 100vw" decoding="async" loading="lazy" alt="Un ejemplo de cómo se ve la versión móvil de una página web gratuita hecha con Jimdo." srcset="../img/mobile-device.png 621w"  srcset="../img/mobile-device.png 621w"></picture>
