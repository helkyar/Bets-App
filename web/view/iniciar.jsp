...
<html>
    ...
    <body>
        ...
        <div class="pay-method">
            <a class="t" href="info-pagos.jsp"><img class="paypal img1" src="../img/paypal.png" alt=""></a>
            <a  class="t" href="info-pagos.jsp"><img class="visa img1" src=" ../img/visa.png" alt=""></a>
            <a class="a-maestro t" href="info-pagos.jsp"><img class="maestro img1" src=" ../img/maestro.png" alt=""></a>
        </div>
        <br>
        <footer>
