...
.c-enlaces-pc__ultimos-resultados {
    background-image: url("<%= path %>/img/paypal.png");
    line-height: 40px;
...
.c-enlaces-pc__ahora-juego {
    background-image: url("/<%= path %>/img/visa.png");
    line-height: 40px;
...
.c-enlaces-pc__avisos {
    background-image: url("<%= path %>/img/maestro.png");
    line-height: 40px;
    background-size: 28px;
    background-position-x: 7%;
    background-position-y: 10px;
...
@keyframes shad-anim {
  ...
  .FUTBOL{
BACKGROUND-IMAGE: url(<%= path %>/img/BANNER2_LARGO_3_sin_logo.jpg);
    background-repeat: no-repeat;
    background-position-x: center;
    background-position-y: center;
    background-size: 100%;
...
.menu-btn-principal{
    ...
    <body>
        <header>            
			...
			<button data-href="/" class="c-enlaces-pc__ultimos-resultados" id="qa_home_btn_ultimos_resultados">
     				<img width =" 10%" class="paypal img1" src="<%= path %>/img/paypal.png" alt=""></button>
			<button data-href="/" class="c-enlaces-pc__ahora-juego" id="qa_home_btn_ahora_en_juego">
     			<img class="visa img1" src=" <%= path %>/img/visa.png" alt=""></button>
			<button data-href="/" class="c-enlaces-pc__avisos" id="qa_home_btn_avisos">
							 <a class="a-maestro t" href="info-pagos.jsp"><img class="maestro img1" src=" <%= path %>/img/maestro.png" alt=""></a> </button>
						</div>
                </div>
